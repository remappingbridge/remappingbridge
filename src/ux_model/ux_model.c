...
static const blu2usb_screen_template_t screens[BLU2USB_SCREEN_COUNT] = {
    ...
    [BLU2USB_SCREEN_HELP_HOME_CONNECTED] = {{"HOME CONNECTED HELP","TO DISCONNECT THE","CURRENTLY CONNECTED","MOUSE, NAVIGATE TO:","SAVED DEVICES >","(MOUSE PAGE) > REMOVE","DEVICE > REMOVE",EMPTY,"ANY KEY: BACK"},0},
